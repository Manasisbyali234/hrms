    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerIconBox}>
          <Ionicons name="keypad-outline" size={40} color={Colors.white} />
        </View>
      ...
      <View style={styles.body}>
        ...
        <View style={styles.timerRow}>
          {timer > 0 ? (
            <View style={styles.timerContent}>
              ...
              <Text style={styles.timerText}> Resend OTP in <Text style={styles.timerCount}>0:{String(timer).padStart(2, '0')}</Text></Text>
            </View>
          ) : (
        ...
        <View style={styles.infoCard}>
          <Ionicons name="information-circle-outline" size={20} color={Colors.warningDark} />
          <Text style={styles.infoText}>
            Didn't receive the code? Check your spam folder or contact IT support.
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  changeMethod: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 20 },
