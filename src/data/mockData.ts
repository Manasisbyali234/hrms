...
export const mockAnnouncements = [
  ...
  {
    id: 'A005',
    title: 'System Maintenance – June 10th Night',
    content: 'The HRMS platform will undergo scheduled maintenance on June 10th from 11 PM to 2 AM. Please save your work and log out before the maintenance window begins.',
    category: 'General',
    priority: 'Urgent',
  ...
  },
  {
    ...
    content: 'The annual performance review cycle for FY 2024-25 will begin on June 20th. All employees are requested to complete their self-assessments by June 30th.',
    category: 'Policy',
    priority: 'High',
    author: 'HR Department',
    date: 'Jun 02, 2025',
...
export const mockTasks = [
  { id: 'T001', title: 'Design Authentication Screens', project: 'HRMS Mobile App', status: 'completed', priority: 'high', dueDate: '2025-06-05', assignee: 'VM', assigneeName: 'Venil Mottana', progress: 100, startDate: '2025-05-20', endDate: '2025-06-05', timeSpent: { days: 3, hours: 5, minutes: 20 }, team: [{ initials: 'VM', color: '#4DA8DA' }, { initials: 'PK', color: '#EC4899' }] },
  { id: 'T002', title: 'Build Dashboard Components', project: 'HRMS Mobile App', status: 'in-progress', priority: 'high', dueDate: '2025-06-10', assignee: 'VM', assigneeName: 'Venil Mottana', progress: 65, startDate: '2025-06-01', endDate: '2025-06-10', timeSpent: { days: 2, hours: 3, minutes: 45 }, team: [{ initials: 'VM', color: '#4DA8DA' }, { initials: 'RS', color: '#34D399' }, { initials: 'SK', color: '#FBBF24' }] },
  { id: 'T003', title: 'Implement Attendance Module', project: 'HRMS Mobile App', status: 'in-progress', priority: 'high', dueDate: '2025-06-15', assignee: 'VM', assigneeName: 'Venil Mottana', progress: 30, startDate: '2025-06-05', endDate: '2025-06-15', timeSpent: { days: 1, hours: 2, minutes: 10 }, team: [{ initials: 'VM', color: '#4DA8DA' }, { initials: 'NP', color: '#F87171' }] },
  { id: 'T004', title: 'Integrate Leave Management API', project: 'MMNext Platform', status: 'todo', priority: 'medium', dueDate: '2025-06-20', assignee: null, assigneeName: null, progress: 0, startDate: '2025-06-12', endDate: '2025-06-20', timeSpent: { days: 0, hours: 0, minutes: 0 }, team: [{ initials: 'RS', color: '#34D399' }, { initials: 'AM', color: '#A78BFA' }] },
  { id: 'T005', title: 'Fix Payroll Calculation Bug', project: 'MMNext Platform', status: 'todo', priority: 'high', dueDate: '2025-06-08', assignee: 'VM', assigneeName: 'Venil Mottana', progress: 0, startDate: '2025-06-06', endDate: '2025-06-08', timeSpent: { days: 0, hours: 0, minutes: 0 }, team: [{ initials: 'VM', color: '#4DA8DA' }] },
  { id: 'T006', title: 'Write Unit Tests for Auth Module', project: 'MMNext Platform', status: 'todo', priority: 'low', dueDate: '2025-06-25', assignee: null, assigneeName: null, progress: 0, startDate: '2025-06-18', endDate: '2025-06-25', timeSpent: { days: 0, hours: 0, minutes: 0 }, team: [{ initials: 'SK', color: '#FBBF24' }, { initials: 'NP', color: '#F87171' }] },
  { id: 'T007', title: 'UI Review & QA Testing', project: 'HRMS Mobile App', status: 'paused', priority: 'medium', dueDate: '2025-06-18', assignee: 'VM', assigneeName: 'Venil Mottana', progress: 50, startDate: '2025-06-08', endDate: '2025-06-18', timeSpent: { days: 1, hours: 4, minutes: 30 }, team: [{ initials: 'VM', color: '#4DA8DA' }, { initials: 'PK', color: '#EC4899' }, { initials: 'RS', color: '#34D399' }] },
];
