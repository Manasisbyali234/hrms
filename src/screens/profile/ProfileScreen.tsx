...
const styles = StyleSheet.create({
  ...
  heroCircle1: { position: 'absolute', width: 300, height: 300, borderRadius: 150, backgroundColor: 'rgba(96,165,250,0.15)', top: -100, right: -80 },
  heroCircle2: { position: 'absolute', width: 180, height: 180, borderRadius: 90, backgroundColor: 'rgba(30,64,175,0.20)', bottom: -60, left: -40 },
